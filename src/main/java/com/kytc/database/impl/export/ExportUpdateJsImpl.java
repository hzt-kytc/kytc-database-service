...
@Service("exportUpdateJsImpl")
public class ExportUpdateJsImpl extends AbstractExportService {

	@Override
	public StringBuffer toStr() {
		// TODO Auto-generated method stub
		this.fileName = "update.js";
		StringBuffer addJs = new StringBuffer("");
		addJs.append("$(function(){")
			.append(tab(1)+"var mainDiv = $(\"#cms_"+htmlName+"_update_main_div\");"+
			...
			.append(tab(1)+"mainDiv.off().on(\"click\",\"a[name='save']\",function(){"+
				...
				tab(3)+"$.ajax({"+
				tab(4)+"url:$.cms.url+rootPath+\"update\","+
				tab(4)+"type:\"post\","+
				tab(4)+"data:jsonData,"+
				tab(4)+"dataType:\"json\","+
